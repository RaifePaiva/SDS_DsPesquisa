    ...
    return (
        ...
        <>
            ...
            <View style={styles.container}>
                ...
                <TextInput keyboardType="numeric" maxLength={150} style={styles.inputText} placeholder="Idade" placeholderTextColor="#9E9E9E" onChangeText={text => setAge(text)} value={age}/> 
                <View style={styles.platformContainer}>
                    <PlatformCard icon="laptop" onChange={handleChangePlatform} activePlatform={platform} platform="PC" />
                    <PlatformCard icon="xbox" onChange={handleChangePlatform} activePlatform={platform} platform="XBOX" />
                    <PlatformCard icon="playstation" onChange={handleChangePlatform} activePlatform={platform} platform="PLAYSTATION" />
                </View>
                <RNPickerSelect 
                    onValueChange={value => {
